...
document.getElementById("switcher").onselect = async event => {
...
document.getElementById("searchButton").onclick = async event => {
  event.preventDefault();
...
if (Number.isNaN(port)) port = 8080; // set your port
